...
// Função auxiliar para adicionar parâmetros de português às URLs de embed do YouTube
export function addPortugueseParameters(embedUrl: string): string {
  if (!embedUrl) return embedUrl

  // Adiciona parâmetros de português se ainda não existem
  const params = "?cc_lang_pref=pt&cc_load_policy=1&hl=pt-br&iv_load_policy=3"

  if (embedUrl.includes("?")) {
    return `${embedUrl}&cc_lang_pref=pt&cc_load_policy=1&hl=pt-br&iv_load_policy=3`
  }
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "25 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/rBXmeNcDz1E"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "30 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/yJTYOHiJpSs"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "28 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/O54PvQIY0ps"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "20 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/fXRSKQ8hrgQ"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "25 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/CdUVpTqlEBw"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "30 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/E_WnU_kee_E"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "15 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/cx4oKIL-Nv8"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "30 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/fWptOzJI3Wc"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "25 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/sF_ICnyxXnw"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "28 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/_yXNph-LU-0"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "20 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/gB8NNnluyBM"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "25 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/5gGqQVGbIYM"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "15 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/kuUZYUBHryw"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "35 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/EQJbY3eFu90"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "30 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/XX1-nL9oM2E"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "10 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/L5MadhSA8MY"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "30 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/SEqetqEW5uU"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "25 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/61mlOpBEnGc"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "28 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/bncm3neK6cM"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "40 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/wKMy9FEpOhw"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "10 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/9eydA0oKJa0"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "15 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/HtJv4Gv5HTQ"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "15 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/Red2IPV9e68"),
        completed: false,
      },
    ],
    completed: false,
    ...
    exercises: [
      {
        ...
        type: "video",
        duration: "20 min",
        url: addPortugueseParameters("https://www.youtube.com/embed/omaC1Bvv80o"),
        completed: false,
      },
    ],
    completed: false,
