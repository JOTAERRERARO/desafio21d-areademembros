...
const bonuses = [
  ...
  },
  {
    ...
    url: "https://www.youtube.com/watch?v=HqqAc4vkjZc",
  },
  {
    id: 4,
    icon: Brain,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-primary/20 to-secondary/20 border-2 border-primary/50 rounded-xl p-8 text-center">
        ...
        <p className="text-gray-300 mb-4">Estamos sempre adicionando novos bônus para os membros do Desafio 21D</p>
        <p className="text-sm text-gray-400">Fique atento às notificações para não perder nenhuma atualização!</p>
      </div>
    </div>
  )
}
